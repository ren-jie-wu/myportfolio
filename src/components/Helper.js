...
const projects = [
  {
    ...
    details: "#### Motivation\n" +
             "As a bioscience researcher, I’ve often wondered: how can I **remember** overwhelming amounts of knowledge? How can I **structure and connect** these ideas to uncover new insights? And how can I **organize** this information from diverse sources to easily **retrieve** it when needed? These questions inspired KGMem—a memory assistant built to address these challenges.\n\n" +
             "#### Challenges and Solutions\n" +
             "1. **Efficient organization**: To handle knowledge from varied sources, KGMem allows users to create and manage **separate notebooks** for different topics or resources. This enhances retrieval efficiency, akin to [Google's NotebookLM](https://notebooklm.google), but with an added edge—leveraging **GraphRAG** for advanced knowledge storage and query.\n" +
             "2. **Connected knowledge**: Understanding relationships between concepts can lead to new discoveries. Visualizing these connections makes learning intuitive and engaging. Unlike tools like [Neo4j](https://neo4j.com/labs/genai-ecosystem/llm-graph-builder/), which rely on rigid query languages like _Cypher_, KGMem uses LLMs for **natural language query processing** and graph techniques to uncover **semantic and structural relationships**. After evaluating options, Microsoft's [GraphRAG](https://github.com/microsoft/graphrag) emerged as the ideal solution, seamlessly integrated into the backend.\n\n" +
             "#### Discussion: Outcomes, Limitations, and Lessons Learned\n" +
             "**Outcomes**: KGMem successfully delivers solutions to the outlined challenges, featuring a **user-friendly interface** and an **interactive graph visualizer** that enriches the knowledge exploration experience. Currently the project is on the stage of cloud deployment for public access to facilitate **continuous evolution** through user feedback in a dev-ops loop. \n\n" +
             "**Limitations & Future Directions**: While the project achieves its goals, areas for improvement include optimizing **graph construction efficiency** and **synonym handling** to avoid redundant nodes. Future work could also involve **scaling the system** for larger datasets and **tailoring features for specific fields**.\n\n" +
             "**Lessons Learned**: This project honed my skills in **full-stack development** with LLM integration and strengthened my ability to lead and manage projects. From competitive analysis to product design, I learned the value of **iterative planning**, **researching tools**, and **adapting scope**—essential skills for delivering a successful product.",
  },
  {
    id: 2,
    title: "GRN Inference",
